# Snippet Kode Penting — Increment 4

## Export Laporan Peminjaman (PDF & Excel)
**File:** app/Http/Controllers/PeminjamanController.php, method laporanExportPdf() & laporanExportExcel()
```php
...
## Isi Lengkap PeminjamanExport
**File:** app/Exports/PeminjamanExport.php
```php
<?php
